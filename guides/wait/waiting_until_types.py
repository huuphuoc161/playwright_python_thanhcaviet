...
with sync_playwright() as playwright:
    ...
    # # Load to page
    # page.goto("https://thanhcaviet.net/", wait_until='load')
    # # Loaded
    ...
    # start_time = perf_counter()
    # # Load to page
    # page.goto("https://thanhcaviet.net/", wait_until = 'domcontentloaded')
    # # Loaded
    # time_taken = perf_counter() - start_time
    # print(f"Page is loaded  in {round(time_taken, 2)}")
    ...
    # start_time = perf_counter()
    # # Load to page
    # page.goto("https://thanhcaviet.net/", wait_until='commit')
    # # Loaded
    # time_taken = perf_counter() - start_time
    # print(f"Page is loaded  in {round(time_taken, 2)}")
    ...
    start_time = perf_counter()
    # Load to page
    page.goto("https://thanhcaviet.net/", wait_until='networkidle')
    # Loaded
    time_taken = perf_counter() - start_time
    print(f"Page is loaded  in {round(time_taken, 2)}")